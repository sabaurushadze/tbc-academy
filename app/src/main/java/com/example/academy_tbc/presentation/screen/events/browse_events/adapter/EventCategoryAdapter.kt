...
class EventCategoryAdapter(
    ...
    inner class UserViewHolder(private val binding: ItemHeaderCategoryBinding) :
        ...
        fun bind(category: EventCategoryUi) = with(binding) {
            tvCategory.text = root.context.getString(getCategoryNameRes(category.categoryType))
            ...
            if (category.selected) {
                ...
                tvCategory.backgroundTintList = ColorStateList.valueOf(root.context.getColor(R.color.light_gray2))

package com.example.academy_tbc.presentation.manager.network
...
class NetworkStateManagerImpl @Inject constructor(
    ...
    private fun isNetworkEffectivelyConnected(networkCapabilities: NetworkCapabilities?): Boolean {
        ...
        val hasInternetAndValidated = networkCapabilities.hasCapability(NetworkCapabilities.NET_CAPABILITY_INTERNET) &&
